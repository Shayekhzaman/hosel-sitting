    ...
    return (
        <main  className="row d-flex align-items-center mt-5">
            ...
            <div className="col-md-4 offset-md-1 mt-3">
                <h1 style={{fontStyle:'poppins', fontWeight:'700', lineHeight:'50px', fontSize:'48px', lineHeight:'60px', marginTop:'20px'}}>Find Your <br/> Hostel Sit! <br/>Be Happy </h1>
                ...
                <button style={{width:'175px',height:'45px', borderRadius:'5px', backgroundColor:'black', color:'white', marginTop:'20px'}}>Inform Us</button>
            </div>
